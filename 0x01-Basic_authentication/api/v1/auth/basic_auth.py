...
class BasicAuth(Auth):
    """
    This class provides authentication using Basic auth.
    ...
    - user_object_from_credentials(user_email, user_pwd)
    ...
    def extract_base64_authorization_header(
        ...
        """
        Extracts the base64 authorization header from the given
    ...
    def extract_user_credentials(
        ...
        Returns:
            tuple: A tuple containing the email and password extracted
    ...
    def user_object_from_credentials(
        ...
        Returns:
            User: The user object if the email and password are valid,
            None otherwise.
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        Returns:
            User: The current user object if the request contains a
            valid authorization header, None otherwise.
        """
